...
export const footerData = {
  ...
  footNote: `<img class='w-8 h-8 mr-2 rtl:mr-0 rtl:ml-2 float-left rtl:float-right rounded-sm' src='/images/footer-icon.webp' alt='Perfectly Hair' loading='lazy'> ✨ Shining a light on salon success. | © ${new Date().getFullYear()} <a class="text-blue-600 underline dark:text-muted" href="#">Perfectly Hair</a> All rights reserved.`,
};
