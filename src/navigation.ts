...
export const footerData = {
  ...
  footNote: `<img class='w-8 h-8 mr-2 rtl:mr-0 rtl:ml-2 float-left rtl:float-right rounded-sm' src='/images/footer-icon.webp' alt='Perfectly Hair' loading='lazy'> © 2025 Perfectly Hair. All rights reserved.`,
};
